...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    @SimpleProperty
    /* renamed from: Y */
    public void mo7336Y(double y) {
        updateY(y);
        registerChange();
    }

    /* renamed from: Y */
    public double mo5791Y() {
    ...
    @SimpleProperty
    /* renamed from: Z */
    public void mo7338Z(double layer) {
        this.zLayer = layer;
