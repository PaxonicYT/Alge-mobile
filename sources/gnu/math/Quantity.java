...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo10959re() {
        return number().mo10959re();
    }

    /* renamed from: im */
    public RealNum mo10958im() {
        return number().mo10958im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo10959re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo10958im().doubleValue();
    }
